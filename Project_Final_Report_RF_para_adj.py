...
for value in [3,5,7,9]:
    ...
    rf_claf = RandomForestClassifier(max_depth = value, n_estimators = 100, max_features = 'sqrt', verbose=False)
...
f1_score = []
for value in [70,90,100,120]:

    rf_claf = RandomForestClassifier(max_depth = 5, n_estimators = value, max_features = 'sqrt', verbose=False)
    rf_claf.fit(feature_train,label_train)
